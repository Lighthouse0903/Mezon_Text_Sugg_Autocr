...
import { AddClanUserEvent, ApiGetZkProofRequest, APISentTokenRequest, ChannelCreatedEvent, ChannelDeletedEvent, ChannelMessage, ChannelUpdatedEvent, DropdownBoxSelected, GiveCoffeeEvent, MessageReaction, QuickMenuEvent, StreamingJoinedEvent, StreamingLeavedEvent, TokenSentEvent, UserChannelAddedEvent, UserChannelRemoved, UserClanRemovedEvent, VoiceEndedEvent, VoiceJoinedEvent, VoiceLeavedEvent, VoiceStartedEvent } from "../../interfaces";
...
export declare class MezonClient extends EventEmitter {
    ...
    mmnApiUrl: string | undefined;
    zkApiUrl: string | undefined;
    private apiClient;
    private mmnClient;
    private zkClient;
    ...
    private messageDB;
    constructor(token?: string, host?: string, port?: string, useSSL?: boolean, timeout?: number, mmnApiUrl?: string, zkApiUrl?: string);
    ...
    sendToken(tokenEvent: APISentTokenRequest): Promise<import("mmn-client-js").AddTxResponse>;
    ...
    onQuickMenuEvent(listener: (e: QuickMenuEvent) => void): this;
    closeSocket(): void;
