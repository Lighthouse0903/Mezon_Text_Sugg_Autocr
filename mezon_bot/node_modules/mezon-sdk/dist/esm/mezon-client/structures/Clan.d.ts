...
export declare class Clan {
    ...
    constructor(initClanData: ClanInitData, client: MezonClient, apiClient: MezonApi, socketManager: SocketManager, sessionToken: string, messageQueue: AsyncThrottleQueue, messageDB: MessageDatabase, mmnApiUrl?: string, zkApiUrl?: string);
