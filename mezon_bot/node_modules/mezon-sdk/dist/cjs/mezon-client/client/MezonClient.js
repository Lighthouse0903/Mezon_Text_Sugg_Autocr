...
class MezonClient extends events_1.EventEmitter {
    constructor(token = DEFAULT_API_KEY, host = DEFAULT_HOST, port = DEFAULT_PORT, useSSL = DEFAULT_SSL, timeout = DEFAULT_TIMEOUT_MS, mmnApiUrl, zkApiUrl) {
        super();
    ...
    initManager(basePath, sessionApi) {
        ...
        if (this.mmnApiUrl) {
            this.mmnClient = new mmn_client_js_1.MmnClient({
                baseUrl: this.mmnApiUrl,
                timeout: this.timeout,
            });
        }
        if (this.zkApiUrl) {
            this.zkClient = new mmn_client_js_1.ZkClient({
